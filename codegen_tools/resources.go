...
var resources_templates = []ResourceTemplateV2{
	...
	ResourceTemplateV2{
		...
		IgnoreUpdates:            NewStringSet("target_exported_dir"),
	},
	ResourceTemplateV2{
	...
	ResourceTemplateV2{
		ResourceName:             "VastDatabase",
		Path:                     ToStringPointer("/api/views/"),
		Model:                    api_latest.VastDatabase{},
		DestFile:                 ToStringPointer("vastdatabase.go"),
		IgnoreFields:             NewStringSet("Id"),
		RequiredIdentifierFields: NewStringSet("bucket", "path"),
		OptionalIdentifierFields: NewStringSet(),
		ListsNamesMap:            map[string][]string{},
		Generate:                 true,
		DataSourceName:           "vastdata_database",
		BeforePostFunc:           utils.AddDatabaseCreationFields,
	},
	ResourceTemplateV2{
		ResourceName:              "VastDatabaseSchema",
		Path:                      ToStringPointer("/api/latest/schemas/"),
		Model:                     api_latest.VastDatabaseSchema{},
		DestFile:                  ToStringPointer("vastdatabaseschema.go"),
		IgnoreFields:              NewStringSet("Id"),
		RequiredIdentifierFields:  NewStringSet("name", "database_name"),
		OptionalIdentifierFields:  NewStringSet(),
		ListsNamesMap:             map[string][]string{},
		Generate:                  true,
		DataSourceName:            "vastdata_database_schema",
		ReadBeforeUnmarshallFunc:  utils.ReadResultField,
		BeforeCreateUnmarshalFunc: utils.VastDatabaseSchemaBeforeCreateUnmarshel,
		IdIsNotNumber:             true,
		DoesNotSupportImport:      true,
		HttpReadFunc:              utils.ReadVastDataDatabseSchema,
		HttpUpdateFunc:            utils.UpdateVastDatabaseSchemaName,
		HttpDeleteFunc:            utils.DeleteVastDatabaseSchema,
		ComputedFields:            NewStringSet("identifier"),
		AfterReadFunc:             utils.AddVastdDatabaseSchemaIdentifierFieled,
	},
	ResourceTemplateV2{
		ResourceName:              "VastDatabaseTable",
		Path:                      ToStringPointer("/api/latest/tables/"),
		Model:                     api_latest.VastDatabaseTable{},
		DestFile:                  ToStringPointer("vastdatadatabasetable.go"),
		IgnoreFields:              NewStringSet("Id"),
		RequiredIdentifierFields:  NewStringSet("name", "fields", "schema_identifier"),
		OptionalIdentifierFields:  NewStringSet(),
		ListsNamesMap:             map[string][]string{},
		Generate:                  true,
		BeforePostFunc:            utils.ConstructTableFields,
		BeforeCreateUnmarshalFunc: utils.VastDatabaseTableBeforeCreateUnmarshel,
		IdIsNotNumber:             true,
		DataSourceName:            "vastdata_database_table",
		DoesNotSupportImport:      true,
		FieldsValidators:          map[string]schema.SchemaValidateDiagFunc{"fields": utils.IsValidFieldsJson},
		HttpReadFunc:              utils.ReadVastDataDatabseTable,
		ReadBeforeUnmarshallFunc:  utils.GenerateTableReadResponse,
		DiffFunc:                  map[string]schema.SchemaDiffSuppressFunc{"fields": utils.JsonStructureCompare},
		HttpDeleteFunc:            utils.DeleteVastDatabaseTable,
	},
}
