...
type Quota struct {
	...
	// The quota enforcement pretty grace period in seconds, minutes, hours or days. Example: 90m
	PrettyGracePeriod string `json:"pretty_grace_period,omitempty"`
	// QQuota enforcement grace period in seconds, minutes, hours or days. Example: 90m
	...
	// Enables or disables alarms when users or groups are exceeding their limits.
	EnableAlarms bool `json:"enable_alarms,omitempty"`
	// The default email address used if there is no suffix specified and no address can be found in the providers.
	DefaultEmail string `json:"default_email,omitempty"`
	// Percentage of used inodes out of the hard limit.
	PercentInodes int32 `json:"percent_inodes,omitempty"`
	// Percentage of used capacity out of the hard limit.
	...
	GroupQuotas       []UserQuota   `json:"group_quotas,omitempty"`
}
