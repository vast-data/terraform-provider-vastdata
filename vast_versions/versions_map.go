...
var vast_versions map[string]map[string]reflect.Type = map[string]map[string]reflect.Type{
	...
	"5.0.0": map[string]reflect.Type{
		...
		"VastDatabase":                    reflect.TypeOf((*version_5_0_0.VastDatabase)(nil)).Elem(),
		"VastDatabaseSchema":              reflect.TypeOf((*version_5_0_0.VastDatabaseSchema)(nil)).Elem(),
		"VastDatabaseTable":               reflect.TypeOf((*version_5_0_0.VastDatabaseTable)(nil)).Elem(),
