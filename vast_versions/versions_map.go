...
var vast_versions map[string]map[string]reflect.Type = map[string]map[string]reflect.Type{
	...
	"5.1.0": map[string]reflect.Type{
		...
		"NonLocalGroup":                   reflect.TypeOf((*version_5_1_0.NonLocalGroup)(nil)).Elem(),
		"NonLocalUser":                    reflect.TypeOf((*version_5_1_0.NonLocalUser)(nil)).Elem(),
		"NonLocalUserKey":                 reflect.TypeOf((*version_5_1_0.NonLocalUserKey)(nil)).Elem(),
		...
		"Saml":                            reflect.TypeOf((*version_5_1_0.Saml)(nil)).Elem(),
	...
	"5.2.0": map[string]reflect.Type{
		...
		"NonLocalGroup":                   reflect.TypeOf((*version_5_2_0.NonLocalGroup)(nil)).Elem(),
		"NonLocalUser":                    reflect.TypeOf((*version_5_2_0.NonLocalUser)(nil)).Elem(),
		"NonLocalUserKey":                 reflect.TypeOf((*version_5_2_0.NonLocalUserKey)(nil)).Elem(),
		...
		"Saml":                            reflect.TypeOf((*version_5_2_0.Saml)(nil)).Elem(),
