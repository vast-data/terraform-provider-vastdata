...
* **vastdata_support_bundles_queue**: Manage support bundle harvest queue entries
...
* **vastdata_blob_expansion**: Look up blob expansion configurations
* **vastdata_certificate**: Look up cluster certificates
* **vastdata_compute_cluster**: Look up compute clusters
* **vastdata_compute_cluster_dashboard**: Read compute cluster dashboard data
* **vastdata_compute_cluster_deployments**: List compute cluster deployments
* **vastdata_compute_cluster_events**: List compute cluster events
* **vastdata_compute_cluster_namespaces**: List compute cluster namespaces
* **vastdata_compute_cluster_nodes**: List compute cluster nodes
* **vastdata_compute_cluster_pods**: List compute cluster pods
* **vastdata_compute_cluster_replica_sets**: List compute cluster replica sets
* **vastdata_compute_cluster_services**: List compute cluster services
* **vastdata_compute_cluster_tenants**: List compute cluster tenants
* **vastdata_quota_group**: Look up quota groups
* **vastdata_support_bundles_queue**: Look up support bundle queue entries
* **vastdata_tenant_metric_labels**: Look up tenant metric label definitions
* **vastdata_tenant_metric_label_values**: Look up per-tenant metric label values
* **vastdata_tenant_metric_label_values_bulk**: Look up bulk tenant metric label values
* **vastdata_tls_certificate**: Look up TLS certificates
