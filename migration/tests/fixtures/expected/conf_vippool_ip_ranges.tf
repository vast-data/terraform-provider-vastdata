...
resource "vastdata_tenant" "tenant_for_adv_pool1" {
    ...
    client_ip_ranges = [
      [var.tenant_client_ip_ranges[0].start_ip, var.tenant_client_ip_ranges[0].end_ip]
    ]
}
...
resource "vastdata_vip_pool" "adv_pool1" {
    ...
    ip_ranges = [
      [var.vippool_range1_start, var.vippool_range1_end],
      [var.vippool_range2_start, var.vippool_range2_end]
    ]
}
