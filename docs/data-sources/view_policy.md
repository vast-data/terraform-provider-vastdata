...
- `vippool_permissions` (List of Object) (Valid for versions: 5.1.0,5.2.0) A list of virtual IP pool permissions. This attribute conflicts with 'vip_pools' and cannot be supplied together with it. (see [below for nested schema](#nestedatt--vippool_permissions))
