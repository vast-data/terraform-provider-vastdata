...
**GidInheritance** | **string** | GID inheritance. BSD - Inherit the GID from the parent folder. LINUX - Inherit the GID from the user. | [optional] [default to null]
**Flavor** | **string** | Sets the security flavor, which determines how file and directory permissions are applied in multiprotocol views | [optional] [default to null]
...
**Use32bitFileid** | **string** | Sets the VAST Cluster&#39;s NFS server to use 32bit file IDs. This setting supports legacy 32-bit applications running over NFS. | [optional] [default to null]
